# -*- coding: utf-8 -*-
"""
Created on Fri May  4 10:24:19 2018
...
for i in range(0, len(stationId)):
    filename = "E:/KDD/test_data/nan_deal_data/df_pre_" + str(i + 1) + "_" + stationId[i] + ".csv"
    ...
    # write file
    outf = "E:/KDD/test_data/drop_duplicate_data/df_dd_" + str(i + 1) + "_" + stationId[i] + ".csv"
    dataset.to_csv(outf)
