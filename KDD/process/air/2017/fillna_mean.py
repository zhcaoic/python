...
for i in range(0, len(stationId)):  
    # read file
    filename = "E:/KDD/test_data/drop_duplicate_data/df_dd_" + str(i + 1) + "_" + stationId[i] + ".csv"
    ...
    outf = "E:/KDD/test_data/reindex_fillmean_data/df_rf_" + str(i + 1) + "_" + stationId[i] + ".csv"
